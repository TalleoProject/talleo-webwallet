...
if (logged_in()) {
  ...
  if (!isset($_POST['recipient']) || !isset($_POST['amount'])) {
    ...
    echo "<tr><th>Recipient address:</th><td><input type='text' maxlength='97' required pattern='TA[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{95}' name='recipient' size='97' oninvalid='javascript:getaddress(this);' onfocusout='javascript:getaddress(this);'></td>";
