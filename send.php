...
if (logged_in()) {
  ...
  if (!isset($_POST['recipient']) || !isset($_POST['amount'])) {
    ...
    echo "<tr><th>Recipient address:</th><td><input type='text' maxlength='97' required pattern='TA[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{95}' name='recipient' id='recipient' size='97' oninvalid='javascript:getaddress(this);' onfocusout='javascript:getaddress(this);'></td>";
    ...
    echo "<tr><th>Recipient e-mail:</th><td><input type='email' name='recipient_email' id='recipient_email' size='40' value='@' onfocusout='javascript:getaddress2();'></td><td></td></tr>";
